...
export 'package:websocket_reconnect/websocket_reconnect.dart';
...
void main() {
  final WebsocketReconnectPlatform initialPlatform =
  ...
  test('getPlatformVersion', () async {
    WebsocketReconnect websocketReconnectPlugin = WebsocketReconnect(
        delay: Duration(seconds: 1), url: 'wss://echo.websocket.events');
    MockWebsocketReconnectPlatform fakePlatform =
        MockWebsocketReconnectPlatform();
